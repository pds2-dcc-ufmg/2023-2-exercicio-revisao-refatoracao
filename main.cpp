...
int main() {
    ...
    ContaCorrente conta1("Joao", 1500, 200);
    ContaPoupanca conta2("Maria", 1000, 2.0);
    ContaPoupanca conta3("Luiz", 3000, 1.5);
    ContaPoupanca conta4("Lara", 2000, 2.5);
    ContaCorrente conta5("Luisa", 5000, 300);
